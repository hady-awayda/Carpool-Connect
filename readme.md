...
- This project uses the [Expo app development framework](https://expo.dev/). Expo is a cross-platform hybrid app development framework for React Native, which allows us to use a single codebase for apps on mobile, desktop, and the web.
